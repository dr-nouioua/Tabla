...
export const Route = createFileRoute('/owner/_authed/')({
  loader: async () => {
    ...
    return { overview, reservations, today }
  },
...
function OwnerReservationsBoard() {
  const { overview, today } = Route.useLoaderData()
      ...
      <div className="mt-6 bg-white rounded-xl border border-stone-200 overflow-hidden">
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-stone-100">
            ...
            {filtered.length === 0 && (
              <tr>
                <td colSpan={6} className="px-4 py-8 text-center text-stone-400">No reservations for this date.</td>
              </tr>
            )}
          </tbody>
        </table>
